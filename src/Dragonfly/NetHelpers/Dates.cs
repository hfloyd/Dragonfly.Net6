...
public static class Dates
{
	...
	/// <summary>
	/// Gets a text representation of the timespan elapsed since a given DateTime (ie: 1 minute, 3 hours, 5 weeks, etc.)
	/// </summary>
	/// <param name="Date"></param>
	/// <returns></returns>
	...
	/// <summary>
	/// Formats a range between two dates using " - " as the delimiter
	/// </summary>
	/// <param name="StartDate"></param>
	/// <param name="EndDate"></param>
	/// <param name="FullDateFormat"></param>
	/// <param name="MonthDateFormat"></param>
	/// <param name="DayDateFormat"></param>
	...
	/// <summary>
	/// Returns a list of Calendar Quarters prior to the provided date
	/// </summary>
